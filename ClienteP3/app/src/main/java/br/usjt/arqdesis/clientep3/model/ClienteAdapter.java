...
//um inflater transforma um layout em uma view
            ...
            ImageView letraCliente = (ImageView)view.
                    findViewById(R.id.foto_cliente);
            TextView nomeCliente = (TextView)view.
                    findViewById(R.id.nome_cliente);
            TextView detalheCliente = (TextView)view.
                    findViewById(R.id.detalhe_cliente);
//faz cache dos widgets instanciados na tag da view para reusar
//quando houver reciclagem
            view.setTag(new ViewHolder(letraCliente, nomeCliente,
                    detalheCliente));
        }
...
//Drawable drawable = Util.getDrawable(context,
        clientes.get(position).getFoto();
        Picasso.with(context).load(
                "http://www.qpainformatica.com.br/exemplorest/images/"+
                        clientes.get(position).getFoto()+".jpg").
                into(holder.getFotoCliente());
